...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('gallery_photo_group_taggings')) {
            return;
        }
        ...
        Schema::create('gallery_photo_group_taggings', function (Blueprint $table) {
            ...
            $table->unique(['gallery_photo_id', 'guest_group_id'], 'gallery_photo_group_unique');
            $table->index('guest_group_id', 'gallery_photo_group_id_index');
        });
    }
